...
class gltfAccessor
{
	...
	public max: number[];
	public min: number[];
	public sparse: { indices: { bufferView: string | number; byteOffset: any; componentType: any; }; count: number; values: { bufferView: string | number; byteOffset: any; }; };
    // sparse.schema.
	public name: string;
	public glBuffer: any;
	public typedView: Uint8Array | Float32Array | Uint32Array | Int8Array | Int16Array | Uint16Array;
	public filteredView: Uint8Array | Float32Array | Uint32Array | Int8Array | Int16Array | Uint16Array;
	public normalizedFilteredView: Uint8Array | Float32Array | Uint32Array | Int8Array | Int16Array | Uint16Array;
	public normalizedTypedView: any;
    ...
    getTypedView(gltf: { bufferViews: { [x: string]: any; }; buffers: { [x: string]: any; }; })
    {
    ...
    getDeinterlacedView(gltf: { bufferViews: { [x: string]: any; }; buffers: { [x: string]: any; }; }): Uint8Array | Float32Array | Uint32Array | Int8Array | Int16Array | Uint16Array
    {
        ...
        if (this.bufferView !== undefined)
        {
            ...
            for(let i = 0; i < arrayLength; ++i)
            {
                ...
                this.filteredView[i] = (dv as any)[func](offset, true);
            }
        }
    ...
    // where quantized data is already normalized. This is useful if the data is not passed
    // to vertexAttribPointer but used immediately (like e.g. animations)
    getNormalizedDeinterlacedView(gltf: any)
    {
    ...
    applySparse(gltf: { bufferViews: { [x: string]: any; }; buffers: { [x: string]: any; }; }, view: number[] | Uint8Array | Float32Array | Uint32Array | Int8Array | Int16Array | Uint16Array)
    {
        // Gather indices.
    ...
    static dequantize(typedArray: Uint8Array | Float32Array | Uint32Array | Int8Array | Int16Array | Uint16Array, componentType: number) : Uint8Array | Float32Array | Uint32Array | Int8Array | Int16Array | Uint16Array
    {
    ...
    getComponentCount(type: string)
    {
        return CompononentCount.get(type);
    }

    getComponentSize(componentType: number)
    {
        switch (componentType)
        {
        case GL.BYTE:
